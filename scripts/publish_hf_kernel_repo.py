#!/usr/bin/env python3
"""Stage and publish the CRUMPET Hugging Face kernel repository.

Author: Chris von Csefalvay
Licence: MIT
Repository: https://github.com/chrisvoncsefalvay/crumpet
...
def upload_staged_repo(
    ...
    commit_message = f"Publish CRUMPET kernel bundle ({commit_suffix})"
    delete_patterns = [
        "build/*",
        "build/**/*",
        "README.md",
...
def parse_args() -> argparse.Namespace:
    ...
    parser = argparse.ArgumentParser(
        description="Stage and publish the CRUMPET Hugging Face kernel repository."
    )
    parser.add_argument(
        "--build-dir",
        type=Path,
